...
from app.models import Flow, Group, Subgroup, SubgroupSchema, FlowSchema, PostFlowSchema, SuccessSchema, IDParameter, GroupSchema
...
def get_cur_flow(id):
    ...
    for group in find_groups:
      ...
      group['subgroups'] = find_subgroups
